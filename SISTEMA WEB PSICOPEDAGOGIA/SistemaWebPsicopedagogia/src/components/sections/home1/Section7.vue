            ...
            <div class="row">
                ...
                <div class="team-block col-xl-3 col-lg-6 col-md-6 col-sm-12 wow fadeInUp">
                    <div class="inner-box">
                        <div class="image-box">
                            <figure class="image">
                                <NuxtLink to="/#"><img src="/images/resource/team-1.jpg" alt=""></NuxtLink>
                            </figure>
                        ...
                        <div class="info-box">
                            <h4 class="name">
                                <NuxtLink to="/#">Edward norton</NuxtLink>
                            </h4>
                ...
                <div class="team-block col-xl-3 col-lg-6 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="400ms">
                    <div class="inner-box">
                        <div class="image-box">
                            <figure class="image">
                                <NuxtLink to="/#"><img src="/images/resource/team-2.jpg" alt=""></NuxtLink>
                            </figure>
                            <span class="share-icon fa fa-share-alt"></span>
                            <div class="social-links">
                                <NuxtLink to="/#"><i class="fab fa-twitter"></i></NuxtLink>
                        ...
                        <div class="info-box">
                            <h4 class="name">
                                <NuxtLink to="/#">Jane seymour</NuxtLink>
                            </h4>
                ...
                <div class="team-block col-xl-3 col-lg-6 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="800ms">
                    <div class="inner-box">
                        <div class="image-box">
                            <figure class="image">
                                <NuxtLink to="/#"><img src="/images/resource/team-3.jpg" alt=""></NuxtLink>
                            </figure>
                            <span class="share-icon fa fa-share-alt"></span>
                            <div class="social-links">
                                <NuxtLink to="/#"><i class="fab fa-twitter"></i></NuxtLink>
                        ...
                        <div class="info-box">
                            <h4 class="name">
                                <NuxtLink to="/#">Mike hardson</NuxtLink>
                            </h4>
                ...
                <div class="team-block col-xl-3 col-lg-6 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="1200ms">
                    <div class="inner-box">
                        <div class="image-box">
                            <figure class="image">
                                <NuxtLink to="/#"><img src="/images/resource/team-4.jpg" alt=""></NuxtLink>
                            </figure>
                            <span class="share-icon fa fa-share-alt"></span>
                            <div class="social-links">
                                <NuxtLink to="/#"><i class="fab fa-twitter"></i></NuxtLink>
                        ...
                        <div class="info-box">
                            <h4 class="name">
                                <NuxtLink to="/#">Christine eve</NuxtLink>
                            </h4>
